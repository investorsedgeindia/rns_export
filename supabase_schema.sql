...
-- Idempotent migration: make phone fully optional (nullable, no CHECK).
-- Older schemas had customers_phone_check which rejected empty strings and
-- broke email-only logins. Drop it entirely so phone is an optional field.
